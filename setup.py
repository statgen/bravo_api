...
setuptools.setup(
    ...
    install_requires=[
        ...
        'marshmallow>=4.0.0', 'pymongo>=4.17.0', 'pysam>=0.23.3', 'python-rapidjson>=1.20',
        'requests>=2.32.4', 'webargs>=8.7.0'
    ],

    extras_require={
        'dev': ['check-manifest', 'icecream'],
        'test': ['mongomock>=3.22.1', 'pytest>=9.1.1', 'pytest-mock>=3.14.1', 'py>=1.11.0',
                 'pytest-mongodb>=2.4.0', 'testfixtures>=6.17.1', 'moto>=5.0.0']
    },
